 ...
 */
class Videos extends \User\Entity\Videos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'User\\Entity\\Videos' . "\0" . 'id', '' . "\0" . 'User\\Entity\\Videos' . "\0" . 'title', '' . "\0" . 'User\\Entity\\Videos' . "\0" . 'file', '' . "\0" . 'User\\Entity\\Videos' . "\0" . 'modules'];
        }
