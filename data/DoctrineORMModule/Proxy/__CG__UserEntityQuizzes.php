 ...
 */
class Quizzes extends \User\Entity\Quizzes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'User\\Entity\\Quizzes' . "\0" . 'id', '' . "\0" . 'User\\Entity\\Quizzes' . "\0" . 'instructions', '' . "\0" . 'User\\Entity\\Quizzes' . "\0" . 'courses'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Quizzes $proxy) {
